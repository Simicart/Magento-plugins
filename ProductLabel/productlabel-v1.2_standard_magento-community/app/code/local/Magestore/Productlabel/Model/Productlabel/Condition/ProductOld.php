 ...
 *  */
class Magestore_Productlabel_Model_Productlabel_Condition_ProductOld extends Mage_Rule_Model_Condition_Abstract {
    ...
    protected function _addSpecialAttributes(array &$attributes) {
        $attributes['attribute_set_id'] = Mage::helper('productlabel')->__('Attribute Set');
        $attributes['category_ids'] = Mage::helper('productlabel')->__('Category');
    }

    /**
     * Load attribute options
     *
     * @return Mage_Productlabel_Model_Productlabel_Condition_Product
     */
