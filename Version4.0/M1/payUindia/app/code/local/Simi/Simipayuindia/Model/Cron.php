...
*Copy PayU India
**/
class Simi_Simipayuindia_Model_Cron {
    ...
    private function _initData() {
        ...
        $this->_merchant_key = Mage::getStoreConfig('payment/simipayuindia/key');		
        //Setting Merchnat Salt
        $this->_merchant_salt = Mage::getStoreConfig('payment/simipayuindia/salt');
        //Setting Ws URL
