 ...
 * @package     Appmerce_Omnikassa
 * @copyright   Copyright (c) 2011-2013 Appmerce (http://www.appmerce.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

class Simi_Simicustompayment_Block_Placement extends Mage_Payment_Block_Form
{
     ...
     *
     * @return Appmerce_Omnikassa_Model_Api_Hosted
     */
    protected function getApi()
    {
        return Mage::getSingleton('omnikassa/api');
    }
    ...
    {
        return $this->getApi()->getGatewayUrl();
    }
