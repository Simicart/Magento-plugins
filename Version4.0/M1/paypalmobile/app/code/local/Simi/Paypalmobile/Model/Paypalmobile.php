 ...
 * @author      Developer
 */
class Simi_Paypalmobile_Model_Paypalmobile extends Mage_Core_Model_Abstract
{
    ...
    public function updatePaypalPaymentv2($dataComfrim)
    {
        if ($dataComfrim->payment_status == '2') {
            ...
            return array('order' => $order, 'message' => Mage::helper('core')->__('The order has been cancelled'));
        }
