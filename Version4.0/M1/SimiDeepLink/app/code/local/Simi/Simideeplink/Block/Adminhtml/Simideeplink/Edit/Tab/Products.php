 ...
 */
 ...
 class Simi_Simideeplink_Block_Adminhtml_Simideeplink_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
     public function __construct($arguments = array()) {
         ...
         $this->setTemplate('simiconnector/simideeplink/productgrid.phtml');
     }
     ...
     protected function _prepareColumns()
     {
         $this->addColumn(
             'in_products', array(
                 ...
                 'use_index' => true,
                 'width'     => '50px',
                 'renderer' => 'simideeplink/adminhtml_simideeplink_edit_tab_renderer_products'
             )
         );
