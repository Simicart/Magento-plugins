...
class Simi_Simimigrate_Model_Server
{
    ...
    public function init(Simi_Simimigrate_Controller_Action $controller)
    {
    ...
    /**
     * @param Simi_Simimigrate_Controller_Action $controller
     * $is_method = 1 - get
     * $is_method = 2 - post
     * $is_method = 3 - update
     * $is_method = 4 - delete
     */
    public function initialize(Simi_Simimigrate_Controller_Action $controller)
    {
        ...
        Mage::dispatchEvent('simi_simimigrate_model_server_initialize', array('object' => $this, 'data' => $this->_data));
    }
