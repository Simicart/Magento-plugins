...
class Simicart_Simimigrate_Model_Server
{
    ...
    {
        $this->_helper = Mage::helper('simimigrate');
    }

    public function init(Simicart_Simimigrate_Controller_Action $controller)
    {
    ...
    /**
     * @param Simicart_Simimigrate_Controller_Action $controller
     * $is_method = 1 - get
     * $is_method = 2 - post
     * $is_method = 3 - update
     * $is_method = 4 - delete
     */
    public function initialize(Simicart_Simimigrate_Controller_Action $controller)
    {
        ...
        Mage::dispatchEvent('simicart_simimigrate_model_server_initialize', array('object' => $this, 'data' => $this->_data));
    }
