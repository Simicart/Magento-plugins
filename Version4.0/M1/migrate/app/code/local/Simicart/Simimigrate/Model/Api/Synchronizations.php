...
class Simicart_Simimigrate_Model_Api_Synchronizations extends Simicart_Simimigrate_Model_Api_Abstract {
        ...
        if (isset($data['migrate_package']['categories']['migrate_categories'])) {
            ...
            foreach ($categories as $category) {
                $newRecord = "INSERT INTO " . $categoryTable
                        . "(app_id, category_id, parent_id, path, position, level, children_count, name, json_name, url_path) "
                        . "VALUES ('" .
                        $appId . "', '" .
                        ...
                        $this->checkString($category['json_name']) . "', '" .
