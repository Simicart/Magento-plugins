...
class Simi_Twout_Model_Observer {
    ...
    public function paymentMethodIsActive($observer) {
        ...
        if ($result->isAvailable && ($method->getCode() == 'twout' || $method->getCode() == 'paypal_mobile')) {
            if ((Mage::app()->getRequest()->getControllerModule() != 'Simi_Connector') && (Mage::app()->getRequest()->getControllerModule() != 'Simi_Simiconnector') && Mage::app()->getRequest()->getControllerModule() != 'Simi_Hideaddress') {
