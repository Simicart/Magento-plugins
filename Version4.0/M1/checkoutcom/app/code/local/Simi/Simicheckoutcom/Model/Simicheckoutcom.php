 ...
 * @author      Developer
 */
class Simi_Simicheckoutcom_Model_Simicheckoutcom extends Mage_Core_Model_Abstract {
    ...
    public function updatePayment($dataComfrim) {
        ...
        $data['payment_status'] = Mage::getStoreConfig('payment/simicheckoutcom/payment_success_status');
