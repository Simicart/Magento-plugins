...
class Simi_Simidailydeal_Block_Adminhtml_Randomdeal_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{ 
  ...
  { 
	...
	protected function _prepareForm()
	{
	  ...
	  $form = new Varien_Data_Form();
            $this->setForm($form);
            $fieldset = $form->addFieldset('randomdeal_edit', array('legend'=>Mage::helper('simidailydeal')->__('Patten Information')));
    ...
    if ((($this->getRandomdeal()->getStatus())!='')){
      ...
      $fieldset->addField('deal_time', 'text', array(
          'label'     => Mage::helper('simidailydeal')->__('Deal time'),
          'required'  => true,
          'name'      => 'deal_time',
