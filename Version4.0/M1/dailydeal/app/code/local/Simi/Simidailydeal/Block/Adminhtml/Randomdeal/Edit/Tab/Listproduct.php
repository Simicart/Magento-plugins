...
class Simi_Simidailydeal_Block_Adminhtml_Randomdeal_Edit_Tab_Listproduct extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        if (($this->getRandomdeal()->getTitle())!='') {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('name', array(
            'header'    => Mage::helper('simidailydeal')->__('Name'),
            'index'     => 'name'
        ));
