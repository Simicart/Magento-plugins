...
class Simi_Simidailydeal_Block_Adminhtml_Randomdeal_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct(){
		...
		$this->_updateButton('save', 'label', Mage::helper('simidailydeal')->__('Save Deal Generator'));
		$this->_updateButton('delete', 'label', Mage::helper('simidailydeal')->__('Delete Deal Generator'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('randomdeal_data') && Mage::registry('randomdeal_data')->getId() ) {
			...
			{
				return Mage::helper('simidailydeal')->__("Patten Information");			
			} else {
				return Mage::helper('simidailydeal')->__("Edit Deal Generator for '%s'", $this->htmlEscape(Mage::registry('randomdeal_data')->getProductName()));
			}
		} else {
            return Mage::helper('simidailydeal')->__('Add Generator');
        }
    }
