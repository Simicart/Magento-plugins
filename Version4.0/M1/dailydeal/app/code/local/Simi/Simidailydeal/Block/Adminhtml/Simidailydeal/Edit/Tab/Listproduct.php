...
class Simi_Simidailydeal_Block_Adminhtml_Simidailydeal_Edit_Tab_Listproduct extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        if ($this->getSimidailydeal() && $this->getSimidailydeal()->getId()) {
    ...
    public function getSelectedRelatedProducts()
    {
		...
		$productIds = array($this->getSimidailydeal()->getProductId());
