...
class Simicart_Simihr_DepartmentController extends Mage_Core_Controller_Front_Action
{
    public function indexAction()
    {
        ...
        $this->getLayout()->getBlock('head')->setTitle($this->__('Simicart Departments'));
        $this->getLayout()->getBlock('head')->setDescription($this->__('Simicart Recruiment Departments'));
        $this->getLayout()->getBlock('head')->setKeywords($this->__('Some Keywords'));
  ...
  //       $this->_initLayoutMessages('core/session');
    ...
    { 
        ...
        $this->getLayout()->getBlock('head')->setTitle($this->__('Simicart '.$department));
        $this->getLayout()->getBlock('head')->setDescription($this->__($department.' Info'));
        $this->getLayout()->getBlock('head')->setKeywords($this->__($department.' Keywords'));
    ...
    public function installDbAction(){
        ...
        ->addColumn($installer->getTable('simihr/jobOffers'),
            'sort_order_id',
            array(
