...
$installer->run("
    ...
    ALTER TABLE  {$this->getTable('simistorelocator')}
	...
	DROP TABLE IF EXISTS {$this->getTable('simistorelocator_specialday')};
    CREATE TABLE {$this->getTable('simistorelocator_specialday')}  (
    ...
    DROP TABLE IF EXISTS {$this->getTable('simistorelocator_holiday')};
    CREATE TABLE {$this->getTable('simistorelocator_holiday')}  (
