...
/**
 * Simirewardpoints Spending Grid Block
 * 
 * @category    Simi
 * @package     Simi_Simirewardpoints
 * @author      Simi Developer
 */
class Simi_Simirewardpoints_Block_Adminhtml_Spending_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();
        $this->setId('simirewardpointsSpendingGrid');
     ...
     *
     * @return Simi_Simirewardpoints_Block_Adminhtml_Spending_Grid
     */
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('points', array(
            'header' => Mage::helper('simirewardpoints')->__('Spending Point(s)'),
            'align' => 'left',
            'index' => 'points',
            'type' => 'number',
        ));
        ...
        $this->addColumn('direction', array(
            ...
            'index' => 'direction',
            'type' => 'options',
            'options' => Mage::getSingleton('simirewardpoints/rate')->getSpendingDirectionHash(),
        ));

        $this->addColumn('money', array(
            'header' => Mage::helper('simirewardpoints')->__('Discount received'),
            'align' => 'right',
            'index' => 'money',
            'type' => 'number',
            'renderer' => 'simirewardpoints/adminhtml_spending_renderer_money',
        ));
        ...
        Mage::dispatchEvent('simirewardpoints_adminhtml_spending_rate_grid', array('grid' => $this));
