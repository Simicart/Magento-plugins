 ...
 * @author   Simi Developer
 */
class Simi_Simigiftvoucher_Model_Mysql4_Giftvoucher_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function joinHistory()
    {
        ...
        $this->getSelect()->group('main_table.giftvoucher_id')->joinLeft(
            array('history' => $this->getTable('simigiftvoucher/history')),
        ...
        )->where('history.amount > ?', 0 or 'history.action = ?', Simi_Simigiftvoucher_Model_Actions::ACTIONS_CREATE);
        return $this;
    }
    ...
    public function getAvailable()
    {
        $this->addFieldToFilter('main_table.status', array(
            'neq' => Simi_Simigiftvoucher_Model_Status::STATUS_DELETED
        ));
        return $this;
    }
    ...
    public function addItemFilter($itemId)
    {
        ...
        $this->getSelect()->joinLeft(
            ...
            ->where('history.action = ?', Simi_Simigiftvoucher_Model_Actions::ACTIONS_CREATE);
