...
/**
 * Class Simi_Simigiftvoucher_Block_Adminhtml_Order_Credit
 */
class Simi_Simigiftvoucher_Block_Adminhtml_Order_Credit extends Mage_Adminhtml_Block_Sales_Order_Totals_Item {
