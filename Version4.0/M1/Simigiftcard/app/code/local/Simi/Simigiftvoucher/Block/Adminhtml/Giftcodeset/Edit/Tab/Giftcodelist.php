...
class Simi_Simigiftvoucher_Block_Adminhtml_Giftcodeset_Edit_Tab_Giftcodelist
    extends Mage_Adminhtml_Block_Widget_Grid
{


    /**
     * Simi_Simigiftvoucher_Block_Adminhtml_Giftcodeset_Edit_Tab_Giftcodelist constructor.
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('simigiftvoucher/giftvoucher')->getCollection()->addFieldToFilter('set_id', $id);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('used',array(
            'header' => Mage::helper('simigiftvoucher')->__('Used'),
            'width' => '10px',
            'align' => 'left',
            'index' => 'used',
            'type' => 'options',
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    'caption' => __('Edit'),
                    'url' => array('base' => '*/simigiftvoucher_giftvoucher/edit'),
                    'field' => 'id'
                )
            ),
            'filter' => false,
