...
/**
 * Class Simi_Simigiftvoucher_Block_Adminhtml_Giftvoucher_Edit_Tab_Shipping
 */
class Simi_Simigiftvoucher_Block_Adminhtml_Giftvoucher_Edit_Tab_Shipping extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('shipping_and_tracking', array(
            'legend' => Mage::helper('simigiftvoucher')->__('Shipping and Tracking Information'))
        );

        $fieldset->addField('shipped_to_customer', 'select', array(
            'label' => Mage::helper('simigiftvoucher')->__('Shipped to Customer'),
            'required' => false,
        ...
        if (is_object($this->getShipment())) {
            ...
            $fieldset->addField('adminhtml_shipment', 'note', array(
                'label' => Mage::helper('simigiftvoucher')->__('Shipment'),
            ...
            $fieldset->addField('adminhtml_tracking', 'note', array(
                'label' => Mage::helper('simigiftvoucher')->__('Tracking Information'),
                'text' => $this->getLayout()->createBlock('adminhtml/sales_order_shipment_view_tracking')
                        ->setShipment($shipment)
                        ->setTemplate('simigiftvoucher/tracking.phtml')->toHtml(),
            ));
        }
