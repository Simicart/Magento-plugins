...
if (Mage::helper('core')->isModuleEnabled('Innoexts_StorePricing') && class_exists('Innoexts_StorePricing_Model_Mysql4_Catalog_Product_Indexer_Price_Default')) {
    abstract class Simi_Simigiftvoucher_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default extends Innoexts_StorePricing_Model_Mysql4_Catalog_Product_Indexer_Price_Default
    {

    }
} elseif (Mage::helper('core')->isModuleEnabled('Innoexts_CurrencyPricing') && class_exists('Innoexts_CurrencyPricing_Model_Mysql4_Bundle_Indexer_Price')) {
    abstract class Simi_Simigiftvoucher_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default extends Innoexts_CurrencyPricing_Model_Mysql4_Bundle_Indexer_Price
    {

    }
} else {
    abstract class Simi_Simigiftvoucher_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default
    {
 ...
 * @author   Simi Developer
 */
class Simi_Simigiftvoucher_Model_Mysql4_Indexer_Price
    extends Simi_Simigiftvoucher_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default
{
     ...
     * @return Simi_Simigiftvoucher_Model_Mysql4_Indexer_Price
     */
    protected function _prepareFinalPriceData($entityIds = null)
    {
        ...
        $giftAmount = $this->_addAttributeToSelect($select, 'simigift_price', 'e.entity_id', 'cs.store_id');
        $defaultAmount = floatval(Mage::getStoreConfig('simigiftvoucher/interface/amount'));
