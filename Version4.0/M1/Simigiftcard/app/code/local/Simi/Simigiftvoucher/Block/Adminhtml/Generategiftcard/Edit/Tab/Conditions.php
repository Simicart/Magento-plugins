...
class Simi_Simigiftvoucher_Block_Adminhtml_Generategiftcard_Edit_Tab_Conditions
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('conditions_fieldset', array(
                'legend' => Mage::helper('simigiftvoucher')->__('Allow using gift codes only if the following conditions are met (leave blank for all shopping carts)'))
