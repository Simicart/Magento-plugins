...
//template 1
$data = array();
$data[0]['template_name'] = Mage::helper('simigiftvoucher')->__('Default Template 1');
...
$data[0]['design_pattern'] = Simi_Simigiftvoucher_Model_Designpattern::PATTERN_LEFT;
//template 2
$data[1]['template_name'] = Mage::helper('simigiftvoucher')->__('Default Template 2');
$data[1]['style_color'] = '#FFFFFF';
$data[1]['text_color'] = '#636363';
$data[1]['caption'] = Mage::helper('simigiftvoucher')->__('Gift Card');
$data[1]['notes'] = '';
$data[1]['images'] = 'default.png';
$data[1]['background_img'] = 'default.png';
$data[1]['design_pattern'] = Simi_Simigiftvoucher_Model_Designpattern::PATTERN_TOP;
//template 3
$data[2]['template_name'] = Mage::helper('simigiftvoucher')->__('Default Template 3');
$data[2]['style_color'] = '#FFFFFF';
$data[2]['text_color'] = '#A9A7A7';
$data[2]['caption'] = Mage::helper('simigiftvoucher')->__('Gift Card');
$data[2]['notes'] = '';
$data[2]['images'] = 'default.png';
$data[2]['background_img'] = 'default.png';
$data[2]['design_pattern'] = Simi_Simigiftvoucher_Model_Designpattern::PATTERN_CENTER;
