 ...
 * @author   Simi Developer
 */
class Simi_Simigiftvoucher_Adminhtml_Simigiftvoucher_GiftproductController extends Mage_Adminhtml_Controller_Action
{

    /**
     * Initialize action
     *
     * @return Simi_Simigiftvoucher_Adminhtml_GiftproductController
     */
    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('simigiftvoucher/giftproduct')
    ...
    public function newAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('simigiftvoucher/adminhtml_giftproduct_edit'))
            ->_addLeft($this->getLayout()->createBlock('simigiftvoucher/adminhtml_giftproduct_edit_tabs'));
    ...
    public function gridAction()
    {
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('simigiftvoucher/adminhtml_giftproduct_grid')->toHtml()
        );
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('simigiftvoucher/giftproduct');
    }
