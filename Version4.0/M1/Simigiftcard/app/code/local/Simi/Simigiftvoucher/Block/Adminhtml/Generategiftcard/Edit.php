...
class Simi_Simigiftvoucher_Block_Adminhtml_Generategiftcard_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{

    /**
     * Simi_Simigiftvoucher_Block_Adminhtml_Generategiftcard_Edit constructor.
     */
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('simigiftvoucher')->__('Save Pattern'));
        $this->_updateButton('delete', 'label', Mage::helper('simigiftvoucher')->__('Delete Template'));
    ...
    public function getHeaderText()
    {
        if (Mage::registry('template_data') && Mage::registry('template_data')->getId()) {
            return Mage::helper('simigiftvoucher')->__("Edit Gift Code Pattern '%s'", 
                $this->htmlEscape(Mage::registry('template_data')->getTemplateName()));
        } else {
            return Mage::helper('simigiftvoucher')->__('New Gift Code Pattern');
        }
    }
