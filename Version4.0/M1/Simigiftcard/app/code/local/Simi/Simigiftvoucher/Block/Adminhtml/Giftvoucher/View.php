...
/**
 * Class Simi_Simigiftvoucher_Block_Adminhtml_Giftvoucher_View
 */
class Simi_Simigiftvoucher_Block_Adminhtml_Giftvoucher_View extends Mage_Core_Block_Template {
    ...
    public function getGiftVoucher() {
        if (!$this->hasData('gift_voucher')) {
            $this->setData('gift_voucher', Mage::getModel('simigiftvoucher/giftvoucher')->load($this->getRequest()->getParam('id'))
            );
        }
    ...
    public function getGiftcardTemplate($template_id) {
        $templates = Mage::getModel('simigiftvoucher/gifttemplate')->load($template_id);
        return $templates;
    }
