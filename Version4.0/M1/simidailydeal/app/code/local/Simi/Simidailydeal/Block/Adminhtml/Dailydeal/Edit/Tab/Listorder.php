...
class Simi_Simidailydeal_Block_Adminhtml_Dailydeal_Edit_Tab_Listorder extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		if (!Mage::registry('deal')) {
			$deal = Mage::getModel('simidailydeal/dailydeal')->load($this->getRequest()->getParam('id'));
