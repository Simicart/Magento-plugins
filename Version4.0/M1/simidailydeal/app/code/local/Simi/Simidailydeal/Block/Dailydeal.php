...
class Simi_Simidailydeal_Block_Dailydeal extends Mage_Catalog_Block_Product_List

{
	 ...
	 *
	 * @param
	 * @return Simi_Simidailydeal_Model_Dailydeal $deals
	 */
	 ...
	 *
	 * @param int $productId
	 * @return Simi_Simidailydeal_Model_Dailydeal $deal
	 */
	public function getDealByProduct($productId)
	{
		$deal = Mage::getModel('simidailydeal/dailydeal')->getDealByProduct($productId);
