...
if (version_compare(Mage::getVersion(), '1.4.1.0', '>=')) {
	$installer->getConnection()->addColumn($this->getTable('sales/order'), 'simidailydeals', 'varchar(255) NULL');
}

$installer->run("

CREATE TABLE IF NOT EXISTS {$this->getTable('simidailydeal/simidailydeal')} (
