...
class Simi_Simidailydeal_Block_Adminhtml_Dailydeal_Edit_Tab_Listproduct extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
        ...
        $this->addColumn('qty', array(
            ...
            'width'   => 100,
            //'value'   => $this->getProduct()->getStockItem()->getQty()
            'index'   => 'qty',
            'type'    => 'number',
            //'options' => Mage::getSingleton('catalog/product_type')->getOptionArray(),
        ));
