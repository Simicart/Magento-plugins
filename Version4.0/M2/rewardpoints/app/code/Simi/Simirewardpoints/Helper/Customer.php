...
class Customer extends Config
{
     ...
     * @param \MSimi\Simirewardpoints\Model\Customer $rewardCustomer
    ...
    public function __construct(
        ...
        \Simi\Simirewardpoints\Helper\Point $point,
        \Magento\Framework\App\State $appState,
        \Simi\Simirewardpoints\Helper\Calculation\Spending $spending
    ) {
    ...
    public function getStoreId()
    {
        if (is_null($this->_storeId)) {
            ...
            } elseif ($this->_appState->getAreaCode() == \Magento\Backend\App\Area\FrontNameResolver::AREA_CODE) {
