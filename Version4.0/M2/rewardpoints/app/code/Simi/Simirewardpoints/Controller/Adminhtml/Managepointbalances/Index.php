...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Reward Point Balances Information'), __('Reward Point Balances Information'));
        $resultPage->getConfig()->getTitle()->prepend(__('Reward Point Balances Information'));
