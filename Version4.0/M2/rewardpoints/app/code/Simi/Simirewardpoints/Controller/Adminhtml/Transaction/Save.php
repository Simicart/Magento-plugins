...
class Save extends \Magento\Customer\Controller\Adminhtml\Index
{
    ...
    public function execute()
    {
        ...
        $this->helperAction = $objectManager->create('\Simi\Simirewardpoints\Helper\Action');
        if ($this->getRequest()->isPost()) {
            try {
                ...
                $transaction = $this->helperAction->addTransaction('admin', $customer, new \Magento\Framework\DataObject([
