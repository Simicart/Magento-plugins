...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Simi_Simirewardpoints::Reward_Points')
                ...
                ->addBreadcrumb(__('Manage Transaction'), __('Manage Transaction'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Earning Rate') : __('New Transaction'),
            $id ? __('Edit Earning Rate') : __('New Transaction')
        );
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Edit Transaction') : __('New Transaction'));
        return $resultPage;
    }
}
