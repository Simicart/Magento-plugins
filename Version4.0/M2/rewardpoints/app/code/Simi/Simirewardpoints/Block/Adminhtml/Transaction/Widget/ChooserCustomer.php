...
namespace Simi\Simirewardpoints\Block\Adminhtml\Transaction\Widget;
...
class ChooserCustomer extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        return $this->getUrl(
            'simirewardpoints/widget/chooserCustomer',
            ['_current' => true, 'current_grid_id' => $this->getId(),
                            'collapse' => null, 'selected' => $this->getRequest()->getParam('selected')]
        );
    }
