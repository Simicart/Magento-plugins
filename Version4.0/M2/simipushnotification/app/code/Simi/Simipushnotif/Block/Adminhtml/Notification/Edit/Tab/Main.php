...
namespace Simi\Simipushnotif\Block\Adminhtml\Notification\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @param \Simi\Simipushnotif\Model\ResourceModel\NotificationFactory $notificationFactory
    ...
    public function _prepareForm()
    {
         ...
         */
        if ($this->_isAllowedAction('Simi_Simipushnotif::save_notification')) {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => '<a href="#" title="Show Product Grid" onclick="toogleProduct();return false;">'
                    ...
                    . $this->getViewFileUrl('Simi_Simipushnotif::images/arrow_down.png')
                    . '" title="" /></a>'
                    . $this->getLayout()
                        ->createBlock('Simi\Simipushnotif\Block\Adminhtml\Notification\Edit\Tab\Productgrid')->toHtml()
            ]
        );
        ...
        $_fieldset->addField(
            ...
            [
                ...
                'after_element_html' => '<a href="#" title="Show Device Grid" onclick="toogleDevice();return false;">'
                    ...
                    . $this->getViewFileUrl('Simi_Simipushnotif::images/arrow_down.png') . '" title="" /></a>'
                    . $this->getLayout()
                        ->createBlock('Simi\Simipushnotif\Block\Adminhtml\Notification\Edit\Tab\Devicegrid')->toHtml()
            ]
        );
