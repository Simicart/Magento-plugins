...
class Devicegrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'renderer' => '\Simi\Simipushnotif\Block\Adminhtml\Notification\Edit\Tab\Devicerender',
            ]
        );
    ...
    public function getSelectedDevices()
    {
        ...
        $notification = $this->simiObjectManager->get('Simi\Simipushnotif\Model\Notification')->load($noticeId);
        $devices = [];
