...
class Productgrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var null|\Simi\Simipushnotif\Model\Notification
     */
     ...
     * @param \Simi\Simipushnotif\Model\Notification $siminotificationFactory
    ...
    public function __construct(
        ...
        \Simi\Simipushnotif\Model\Notification $siminotificationFactory,
    ...
    public function getSelectedProducts()
    {
        ...
        $siminotification = $this->simiObjectManager
            ->get('Simi\Simipushnotif\Model\Notification')->load($notice_id);
        $products = [];
