...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function _construct()
    {
        ...
        if ($this->_isAllowedAction('Simi_Simipushnotif::delete_notification')) {
    ...
    {
        return $this->getUrl('simipushadmin/*/save', ['_current' => true,
    ...
    {
        $arrow_down_img = $this->getViewFileUrl('Simi_Simipushnotif::images/arrow_down.png');
        $arrow_up_img   = $this->getViewFileUrl('Simi_Simipushnotif::images/arrow_up.png');
