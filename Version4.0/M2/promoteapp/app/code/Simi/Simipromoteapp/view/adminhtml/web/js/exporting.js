/**
 * Created by Anthony on 8/10/2015.
 */
/*
 ...
 */
(function (f) {
    var z = f.Chart, s = f.addEvent, A = f.removeEvent, B = HighchartsAdapter.fireEvent, j = f.createElement, p = f.discardElement, u = f.css, l = f.merge, m = f.each, q = f.extend, E = f.splat, F = Math.max, k = document, C = window, G = f.isTouchDevice, H = f.Renderer.prototype.symbols, r = f.getOptions(), x;
    q(r.lang, {
    ...
    q(z.prototype, {
        sanitizeSVG: function (b) {
            ...
            h = d.exporting.sourceHeight ||
                d.chart.height || /px$/.test(h) && parseInt(h, 10) || 400;
            ...
            var e = this.getSVGForExport(b,
                a), b = l(this.options.exporting, b);
            f.post(b.url, {
            ...
            if (!b.isPrinting)b.isPrinting = !0, B(b, "beforePrint"), m(f, function (a, b) {
            ...
            if (c.enabled !== !1) {
                ...
                d.add().align(q(c, {width: d.width, x: f.pick(c.x, x)}), !0, "spacingBox");
                x += (d.width + c.buttonSpacing) * (c.align === "right" ? -1 : 1);
                a.exportSVGElements.push(d, h)
            }
        }, destroyExport: function (b) {
            var b = b.target, a, e;
            for (a = 0; a < b.exportSVGElements.length; a++)if (e = b.exportSVGElements[a])e.onclick = e.ontouchstart = null, b.exportSVGElements[a] =
                e.destroy();
