 ...
 */
class Hyperpay extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Simi\Hyperpay\Model\ResourceModel\Hyperpay $resource,
        \Simi\Hyperpay\Model\ResourceModel\Hyperpay\Collection $resourceCollection
    )
    {
    ...
    {
        $this->_init('Simi\Hyperpay\Model\ResourceModel\Hyperpay');
    }
    ...
    protected function _initInvoicev2($orderId, $data) {
        ...
        try {
            $ppMobileModel = $this->simiObjectManager->get('Simi\Hyperpay\Model\Hyperpay')
                ->setData('transaction_id', $data['transaction_id'])
                ->setData('transaction_name', $data['fund_source_type'])
                ->setData('transaction_email', $data['transaction_email'])
                ->setData('amount', $data['amount'])
