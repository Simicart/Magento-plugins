 ...
 */
class Simi_Simivideo_Block_Adminhtml_Simivideo_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct($arguments = array()) {
        ...
        $this->setTemplate('simivideo/grid.phtml');
    }
    ...
    protected function _prepareColumns() {
        $this->addColumn('in_products', array(
            ...
            'use_index' => true,
            'width'     => '50px',
            'renderer' => 'simivideo/adminhtml_simivideo_edit_tab_render'
        ));
