...
/**
 * Fblogin Index Controller
 * 
 * @category 	Magestore
 * @package 	Magestore_Fblogin
 * @author  	Magestore Developer
 */
class Simi_Fblogin_IndexController extends Mage_Core_Controller_Front_Action {
   ...
   public function _printDataJson($data) {
    ...
    public function loginAction() {		
        $data = $this->getData();				
        $information = Mage::getModel('fblogin/fblogin')->login($data);
