 ...
 */
class Simi_Fblogin_Model_Fblogin extends Simi_Connector_Model_Abstract {
    ...
    public function login($data) {  
        ...
        if ((int) Mage::getStoreConfig("fblogin/general/enable") == 0) {
            return Mage::getSingleton('core/session')->addError(Mage::helper('fblogin')->__('Extension was disable'));
        }
        $email = $data->email;
        $name = $data->name;        
        ...
        $information['message'] = array(Mage::helper('fblogin')->__('Login Success'));
        $result = array();
