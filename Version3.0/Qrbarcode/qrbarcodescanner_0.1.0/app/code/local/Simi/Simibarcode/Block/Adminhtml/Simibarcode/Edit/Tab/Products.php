...
class Simi_Simibarcode_Block_Adminhtml_Simibarcode_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() 
    {
        ...
        $this->addColumn('product_name', array(
            'header' => Mage::helper('simibarcode')->__('Name'),
            'align' => 'left',
            'index' => 'name'
        ));
        ...
        $this->addColumn('product_sku', array(
            'header' => Mage::helper('simibarcode')->__('SKU'),
            'width' => '80px',
            'index' => 'sku'
        ));
        ...
        $this->addColumn('barcode', array(
            ...
            'editable' => true,
            'edit_only' => true,
            'renderer' => 'simibarcode/adminhtml_simibarcode_edit_renderer_barcodecustom',
        ));

        $this->addColumn('qrcode', array(
            'header' => Mage::helper('simibarcode')->__('QR code'),
            'align' => 'left',
            'width' => '130px',
            'index' => 'qrcode',
            'type' => 'input',
            'editable' => true,
            'edit_only' => true,
            'renderer' => 'simibarcode/adminhtml_simibarcode_edit_renderer_qrcodecustom',
        ));
        ...
        $this->addColumn('status', array(
            ...
            // 'renderer' => 'simibarcode/adminhtml_simibarcode_edit_renderer_select',
        ));
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'    => Mage::helper('simibarcode')->__('View'),
