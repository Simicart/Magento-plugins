...
/**
 * Simibarcode Display Model
 * 
 * @category    Magestore
 * @package     Magestore_Simibarcode
 * @author      Magestore Developer
 */
class Simi_Simibarcode_Model_Printbarcode_Function extends Varien_Object {
    ...
    {
        $availableBarcodes = Mage::helper('simibarcode/print')->getBarcodeList();
